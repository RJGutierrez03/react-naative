...
const Abs6 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      source={{ 
        uri: 'https://im.indiatimes.in/media/content/2019/Oct/flutter_kicks_1570189723.jpg' 
        }} />

      <Text style={styles.name}>FLUTTER KICKS</Text>
      <Text style={styles.set}>2 SET | 15 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Flutter-Kicks.mp3")}
        useNativeControls
