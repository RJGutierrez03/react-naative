...
const Body = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Image style={styles.exer} source={{ uri: 'https://media1.popsugar-assets.com/files/thumbor/s7FFKGlKZkCmeK0v1MNr0wT5WIA/fit-in/2048xorig/filters:format_auto-!!-:strip_icc-!!-/2017/05/23/036/n/1922729/f2d40eb0a86b7153_Circuit-2-Slow-Mountain-Climber/i/Circuit-1-Move-3-Mountain-Climbers.jpg' }} />

      <Text style={styles.name}>MOUNTAIN CLIMBER</Text>
      <Text style={styles.set}>2 SET | 15 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Mountain-Climber.mp3")}
        useNativeControls
