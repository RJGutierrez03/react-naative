    ...
    return (
        <SafeAreaView style={styles.container}>
            <Image style={styles.exer}
                source={{
                    uri: 'https://www.muscleandfitness.com/wp-content/uploads/2014/02/185_B.jpg?quality=86&strip=all'
                }} />

            <Text style={styles.name}>INCLINED DUMBBELL PULLOVER</Text>
            <Text style={styles.set}>2 SET | 10 REPS</Text>

            <Video
                ref={video}
                style={styles.video}
                source={require("../assets/audio/Inclined-Dumbbell-Pullover.mp3")}
                useNativeControls
