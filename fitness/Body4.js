...
const Body4 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Image style={styles.exer} source={{ uri: 'https://media1.popsugar-assets.com/files/thumbor/MLTjAv4FACeEzp_wRYJ8U8AT2lo/fit-in/2048xorig/filters:format_auto-!!-:strip_icc-!!-/2013/12/26/734/n/1922729/1c4643298f9310f6_bridge/i/Beginner-Single-Leg-Bridge.jpg' }} />

      <Text style={styles.name}>SINGLE-LEG BRIDGE</Text>
      <Text style={styles.set}>2 SET | 15 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Single-Leg-Bridge.mp3")}
        useNativeControls
