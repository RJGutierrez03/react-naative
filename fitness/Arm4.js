...
const Arm4 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Image style={styles.exer} source={{ uri: 'https://gethealthyu.com/wp-content/uploads/2014/10/Lateral-Raise_Exercise.jpg' }} />

      <Text style={styles.name}>LATERAL RAISE</Text>
      <Text style={styles.set}>2 SET | 10 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Dumbbell-Lateral-Raise.mp3")}
        useNativeControls
