...
const Abs5 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      source={{ 
        uri: 'https://media1.popsugar-assets.com/files/thumbor/lFwWV0y8B5duZJzTShxxTohmUtc/fit-in/728xorig/filters:format_auto-!!-:strip_icc-!!-/2017/11/06/988/n/1922729/029fce065a00e5b1b23a14.88742394_edit_img_twitter_post_image_file_44224815_1510002578.jpg' 
        }} />

      <Text style={styles.name}>PLANK LEG LIFT</Text>
      <Text style={styles.set}>2 SET | 15 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Plank-Leg-Lifts.mp3")}
        useNativeControls
