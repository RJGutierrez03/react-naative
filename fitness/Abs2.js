...
const Abs2 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      source={{ 
        uri: 'https://bod-blog-assets.prod.cd.beachbodyondemand.com/bod-blog/wp-content/uploads/2017/10/bb_bicycle-crunch.jpg' 
        }} />

      <Text style={styles.name}>AIR BIKE CRUNCHES</Text>
      <Text style={styles.set}>2 SET | 15 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Bicycle-Crunches.mp3")}
        useNativeControls
