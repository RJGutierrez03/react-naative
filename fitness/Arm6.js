...
const Arm6 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Image style={styles.exer} source={{ uri: 'https://s3.amazonaws.com/prod.skimble/assets/2451478/image_iphone.jpg' }} />

      <Text style={styles.name}>LYING DUMBBELL TRICEP</Text>
      <Text style={styles.set}>2 SET | 10 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Lying-Tricep-Extension.mp3")}
        useNativeControls
