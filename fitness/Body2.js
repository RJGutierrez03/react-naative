...
const Body2 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Image style={styles.exer} source={{ uri: 'https://cdn2.stylecraze.com/wp-content/uploads/2021/08/Incline-Push-Ups-1.jpg' }} />

      <Text style={styles.name}>INCLINE PUSH-UPS</Text>
      <Text style={styles.set}>2 SET | 15 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/INCLINE-PUSH-UPS.mp3")}
        useNativeControls
