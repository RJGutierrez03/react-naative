    ...
    return (
        <SafeAreaView style={styles.container}>
            <Image style={styles.exer}
                source={{
                    uri: 'https://bod-blog-assets.prod.cd.beachbodyondemand.com/bod-blog/wp-content/uploads/2018/03/26122257/incline-dumbbell-press-600-demo.jpg'
                }} />

            <Text style={styles.name}>INCLINE DUMBBELL PRESS</Text>
            <Text style={styles.set}>2 SET | 10 REPS</Text>

            <Video
                ref={video}
                style={styles.video}
                source={require("../assets/audio/Dumbbell-Chest-Press.mp3")}
                useNativeControls
