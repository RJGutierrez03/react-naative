...
const Legs6 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      source={{ 
        uri: 'https://s3.amazonaws.com/prod.skimble/assets/1185091/image_iphone.jpg' 
        }} />

      <Text style={styles.name}>CALVES RAISE</Text>
      <Text style={styles.set}>2 SET | 8 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Calf-Raises.mp3")}
        useNativeControls
