    ...
    return (
        <SafeAreaView style={styles.container}>
            <Image style={styles.exer}
                source={{
                    uri: 'https://www.muscleandfitness.com/wp-content/uploads/2017/04/Bench-Press-Main-800800.jpg?w=800&h=630&crop=1&quality=86&strip=all'
                }} />

            <Text style={styles.name}>BARBELL BENCH PRESS</Text>
            <Text style={styles.set}>2 SET | 10 REPS</Text>

            <Video
                ref={video}
                style={styles.video}
                source={require("../assets/audio/Barbell-Chest-Press.mp3")}
                useNativeControls
