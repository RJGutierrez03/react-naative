    ...
    return (
        <SafeAreaView style={styles.container}>
            <Image style={styles.exer}
                source={{
                    uri: 'https://s3.amazonaws.com/prod.skimble/assets/726326/image_iphone.jpg'
                }} />

            <Text style={styles.name}>DUMBBELL PULLOVER</Text>
            <Text style={styles.set}>2 SET | 10 REPS</Text>

            <Video
                ref={video}
                style={styles.video}
                source={require("../assets/audio/Dumbbell-Pullover.mp3")}
                useNativeControls
