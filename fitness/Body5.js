...
const Body5 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Image style={styles.exer} source={{ uri: 'https://cdn.shopify.com/s/files/1/1497/9682/articles/1_a9d19710-8ac5-44c7-9685-31970351036d_750x.jpg?v=1648740804' }} />

      <Text style={styles.name}>JUMP SQUATS</Text>
      <Text style={styles.set}>2 SET | 15 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Jump-Squat.mp3")}
        useNativeControls
