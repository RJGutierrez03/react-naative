...
const Legs5 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      source={{ 
        uri: 'https://www.powerliftusa.com/filesimages/high-school/gallery_products/proselect_comboprone/photos/Combo_Prone_Leg_Curl_-_Leg_Extension2.jpg' 
        }} />

      <Text style={styles.name}>LEG EXTENSION</Text>
      <Text style={styles.set}>2 SET | 8 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Plank-Leg-Extension-Pulses.mp3")}
        useNativeControls
