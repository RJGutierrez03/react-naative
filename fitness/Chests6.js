    ...
    return (
        <SafeAreaView style={styles.container}>
            <Image style={styles.exer}
                source={{
                    uri: 'https://www.bodybuilding.com/images/2020/xdb/originals/xdb-2m-chest-dip-m1-16x9.jpg'
                }} />

            <Text style={styles.name}>CHEST DIPS</Text>
            <Text style={styles.set}>2 SET | 10 REPS</Text>

            <Video
                ref={video}
                style={styles.video}
                source={require("../assets/audio/Tricep-Dips.mp3")}
                useNativeControls
