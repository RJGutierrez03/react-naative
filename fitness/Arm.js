...
const Arm = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Image style={styles.exer} source={{ uri: 'https://gethealthyu.com/wp-content/uploads/2014/07/Shoulder-Overhead-Press_Exercise.jpg' }} />

      <Text style={styles.name}>OVERHEAD SHOULDER PRESS</Text>
      <Text style={styles.set}>2 SET | 10 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Dumbbell-Shoulder-Press.mp3")}
        useNativeControls
