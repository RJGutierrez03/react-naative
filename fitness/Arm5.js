...
const Arm5 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Image style={styles.exer} source={{ uri: 'https://media1.popsugar-assets.com/files/thumbor/BaNHSTRglD_KL803yQAmkg-y7Ic/fit-in/1024x1024/filters:format_auto-!!-:strip_icc-!!-/2014/03/26/818/n/1922729/8cfd5332633bc652_reverse-fly-reallly.jpg' }} />

      <Text style={styles.name}>REVERSE FLY</Text>
      <Text style={styles.set}>2 SET | 10 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Standing-Chest-Fly.mp3")}
        useNativeControls
