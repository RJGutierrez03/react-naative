...
const Arm3 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Image style={styles.exer} source={{ uri: 'https://www.gymguider.com/wp-content/uploads/2017/10/incline-dumbbell-curl-1.jpg' }} />

      <Text style={styles.name}>INCLINE DUMBBELL CURL</Text>
      <Text style={styles.set}>2 SET | 10 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Bicep-Curls.mp3")}
        useNativeControls
