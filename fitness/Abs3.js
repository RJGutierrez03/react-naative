...
const Abs3 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      source={{ 
        uri: 'https://i.pinimg.com/736x/70/c2/65/70c2652a92ba946bc6a37f13563fda03.jpg' 
        }} />

      <Text style={styles.name}>SITTING TWISTS</Text>
      <Text style={styles.set}>2 SET | 15 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Russian-Twist.mp3")}
        useNativeControls
