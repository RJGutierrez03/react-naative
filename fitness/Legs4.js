...
const Legs4 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      source={{ 
        uri: 'https://s3.amazonaws.com/prod.skimble/assets/2166326/image_iphone.jpg' 
        }} />

      <Text style={styles.name}>HAMSTRING CURLS</Text>
      <Text style={styles.set}>2 SET | 8 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Lying-Hamstring-Curls.mp3")}
        useNativeControls
