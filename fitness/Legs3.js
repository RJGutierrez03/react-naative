...
const Legs3 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      source={{ 
        uri: 'https://s3.amazonaws.com/prod.skimble/assets/957329/image_iphone.jpg' 
        }} />

      <Text style={styles.name}>BULGARIAN DEADLIFT</Text>
      <Text style={styles.set}>2 SET | 8 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Bulgarian-Split-Squat.mp3")}
        useNativeControls
