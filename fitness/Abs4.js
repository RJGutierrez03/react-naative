...
const Abs4 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      source={{ 
        uri: 'https://i.pinimg.com/originals/c4/d8/4b/c4d84bc8a926d8fcdd3c18b899eddb11.jpg' 
        }} />

      <Text style={styles.name}>LEG RAISE CRUCHES</Text>
      <Text style={styles.set}>2 SET | 15 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Straight-Leg-Raise.mp3")}
        useNativeControls
