...
const Legs2 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      source={{ 
        uri: 'http://cdn.shopify.com/s/files/1/1497/9682/articles/1_7fa12c3e-d3bc-405f-b0c7-6eaf02498a72.jpg?v=1646827902' 
        }} />

      <Text style={styles.name}>ROMANIAN DEADLIFT</Text>
      <Text style={styles.set}>2 SET | 8 REPS</Text>

      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/audio/Romanian-Deadlift.mp3")}
        useNativeControls
